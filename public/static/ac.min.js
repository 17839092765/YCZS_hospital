...
$jscomp.polyfill = function(a, b, c, h) {
  b &&
    ($jscomp.ISOLATE_POLYFILLS
      ? $jscomp.polyfillIsolated(a, b, c, h)
      : $jscomp.polyfillUnisolated(a, b, c, h))
}
$jscomp.polyfillUnisolated = function(a, b, c, h) {
  c = $jscomp.global
  a = a.split(".")
...
$jscomp.polyfillIsolated = function(a, b, c, h) {
  var d = a.split(".")
  a = 1 === d.length
  h = d[0]
  ...
  d = d[d.length - 1]
  c = $jscomp.IS_SYMBOL_NATIVE && "es6" === c ? h[d] : null
  b = b(c)
  null != b &&
    (a
...
$jscomp.getConstructImplementation = function() {
  ...
  return function(c, h, d) {
    ...
    return Function.prototype.apply.call(c, d, h) || d
  }
}
    ...
    for (c in b)
      if ("prototype" != c)
        if (Object.defineProperties) {
          var h = Object.getOwnPropertyDescriptor(b, c)
          h && Object.defineProperty(a, c, h)
        } else a[c] = b[c]
  ...
  function(a) {
    function b() {
      ...
      try {
        ...
        if (2 != p.get(e) || 3 != p.get(f)) return !1
        p.delete(e)
        p.set(f, 4)
        return !p.has(e) && 4 == p.get(f)
      } catch (t) {
        return !1
      }
    }
    ...
    function h(e) {
      var f = typeof e
      return ("object" === f && null !== e) || "function" === f
    }
    function d(e) {
      if (!$jscomp.owns(e, g)) {
        var f = new c()
        $jscomp.defineProperty(e, g, { value: f })
      }
    }
    function l(e) {
    ...
    k.prototype.set = function(e, f) {
      if (!h(e)) throw Error("Invalid WeakMap key")
      d(e)
      if (!$jscomp.owns(e, g)) throw Error("WeakMap key fail: " + e)
      e[g][this.id_] = f
      return this
    }
    k.prototype.get = function(e) {
      return h(e) && $jscomp.owns(e, g) ? e[g][this.id_] : void 0
    }
    k.prototype.has = function(e) {
      return h(e) && $jscomp.owns(e, g) && $jscomp.owns(e[g], this.id_)
    }
...
$jscomp.polyfill(
  ...
  function(a) {
    function b() {
      ...
      try {
        var k = Object.seal({ x: 4 }),
          e = new a($jscomp.makeIterator([[k, "s"]]))
        if (
          "s" != e.get(k) ||
          1 != e.size ||
          e.get({ x: 4 }) ||
    ...
    var c = new WeakMap(),
      h = function(k) {
        ...
        if (k) {
          ...
          for (var e; !(e = k.next()).done; )
            (e = e.value), this.set(e[0], e[1])
        }
      }
    h.prototype.set = function(k, e) {
      k = 0 === k ? 0 : k
      var f = d(this, k)
    ...
    h.prototype.forEach = function(k, e) {
      for (var f = this.entries(), p; !(p = f.next()).done; )
        (p = p.value), k.call(e, p[1], p[0], this)
    }
    ...
    var d = function(k, e) {
        ...
        "object" == f || "function" == f
          ...
          : (f = "p_" + e)
        var p = k.data_[f]
        if (p && $jscomp.owns(k.data_, f))
          for (k = 0; k < p.length; k++) {
            var t = p[k]
            if ((e !== e && t.key !== t.key) || e === t.key)
              return { id: f, list: p, index: k, entry: t }
          }
        return { id: f, list: p, index: -1, entry: void 0 }
      },
      l = function(k, e) {
        var f = k.head_
        return $jscomp.iteratorPrototype(function() {
          if (f) {
            ...
            for (; f.next != f.head; )
              return (f = f.next), { done: !1, value: e(f) }
            f = null
          }
  ...
  function(a) {
    return a
      ...
      : function(b, c) {
          ...
          b += ""
          void 0 === c && (c = h.length)
          c = Math.max(0, Math.min(c | 0, h.length))
  ...
  function(a) {
    ...
    d.prototype.resolveTo_ = function(g) {
      if (g === this)
        ...
        q ? this.resolveToNonPromiseObj_(g) : this.fulfill_(g)
      }
    }
    d.prototype.resolveToNonPromiseObj_ = function(g) {
      ...
      "function" == typeof q
        ? this.settleSameAsThenable_(q, g)
        : this.fulfill_(g)
    }
    ...
    d.prototype.settle_ = function(g, q) {
      if (0 != this.state_)
        throw Error(
          "Cannot settle(" +
            g +
    ...
    d.prototype.settleSameAsPromise_ = function(g) {
      var q = this.createResolveAndReject_()
      g.callWhenSettled_(q.resolve, q.reject)
    }
    d.prototype.settleSameAsThenable_ = function(g, q) {
      var k = this.createResolveAndReject_()
      try {
        g.call(q, k.resolve, k.reject)
      } catch (e) {
        k.reject(e)
      }
    }
    d.prototype.then = function(g, q) {
      function k(t, r) {
      ...
      var e,
        f,
        p = new d(function(t, r) {
          e = t
          f = r
        })
      this.callWhenSettled_(k(g, e), k(q, f))
      return p
    }
    d.prototype.catch = function(g) {
      return this.then(void 0, g)
    }
    d.prototype.callWhenSettled_ = function(g, q) {
      function k() {
        switch (e.state_) {
          case 1:
            g(e.result_)
    ...
    d.race = function(g) {
      return new d(function(q, k) {
        for (
          var e = $jscomp.makeIterator(g), f = e.next();
          !f.done;
          f = e.next()
        )
          c(f.value).callWhenSettled_(q, k)
      })
    }
    d.all = function(g) {
      var q = $jscomp.makeIterator(g),
        k = q.next()
      return k.done
        ? c([])
        : new d(function(e, f) {
            ...
            do
              t.push(void 0),
                r++,
                c(k.value).callWhenSettled_(p(t.length - 1), f),
                (k = q.next())
            while (!k.done)
          })
    }
  ...
  $jscomp.TRUST_ES6_POLYFILLS && "function" == typeof Object.assign
    ...
    : function(a, b) {
        for (var c = 1; c < arguments.length; c++) {
          var h = arguments[c]
          if (h) for (var d in h) $jscomp.owns(h, d) && (a[d] = h[d])
        }
        return a
      }
$jscomp.polyfill(
    ...
    return a
      ...
      : function(b, c) {
          ...
          var d = h.length,
            l = b.length
          c = Math.max(0, Math.min(c | 0, h.length))
          for (var g = 0; g < l && c < d; ) if (h[c++] != b[g++]) return !1
          return g >= l
        }
  },
  "es6",
  ...
  function(a) {
    return a
      ...
      : function(b) {
          ...
          b |= 0
          for (var h = ""; b; ) if ((b & 1 && (h += c), (b >>>= 1))) c += c
          return h
        }
  },
  "es6",
...
var AcApiVersion = 327,
  ...
  CommandType = {
    ...
    Misc_SetMainUIVisibility: 34,
    Misc_SetQueryToolState: 35,
    Tag_Add: 36,
    Tag_Delete: 37,
    Tag_Update: 38,
    Tag_Clear: 39,
    ...
    CustomBuilder_Start: 157,
    CustomBuilder_Quit: 158,
    CustomBuilder_Finish: 159,
    CustomBuilder_SetParam: 160,
    ...
    Tools_EnterMeasurement: 195,
    Tools_ExitMeasurement: 196,
    Viewshed_Add: 197,
    Viewshed_Update: 198,
    Viewshed_Focus: 199,
    Viewshed_Delete: 200,
    ...
    if (b)
      for (a = $jscomp.makeIterator(b), c = a.next(); !c.done; c = a.next()) {
        ...
        for (var h = c.next(); !h.done; h = c.next()) {
          ...
          for (var d = h.next(); !d.done; d = h.next())
...
var LayerVisibleData = function(a, b) {
  ...
  HeatMapPointData = function(a, b, c, h) {
    this.id = a.toString()
    this.coordinate = b
    this.radius = c
    this.heatValue = h
  },
  TagData = function(a, b, c, h, d, l, g, q, k, e, f, p, t, r) {
    this.id = a.toString()
    this.coordinate = b
    this.imagePath = c
    this.imageSize = h
    ...
    this.textBackgroundColor = e || [1, 1, 1, 0.85]
    this.textBorderColor = f || [0, 0, 0, 0]
    this.textRange = p || 1e5
  ...
  CustomTagData = function(a, b, c, h, d, l, g) {
    this.id = a.toString()
    this.coordinate = b
    this.contentURL = c.url
    this.contentSize = [c.width, c.height]
    this.popupURL = h.url
    this.popupSize = [h.width, h.height]
    this.pivot = d
    this.range = l
    this.autoHidePopupWindow = g || !0
  },
  HighlightAreaData = function(a, b, c, h, d, l) {
    this.id = a.toString()
  ...
  ImageButtonData = function(a, b, c, h, d, l, g, q) {
    this.id = a.toString()
    this.x = b
    this.y = c
    this.width = h
  ...
  AnimatedImageButtonData = function(a, b, c, h, d, l, g, q, k) {
    this.id = a.toString()
    this.x = b
    this.y = c
    this.width = h
  ...
  BeamData = function(a, b, c, h, d, l, g) {
    this.id = a.toString()
    this.duration = b
    this.thickness = c
    this.interval = h
  ...
  RadiationPointData = function(a, b, c, h, d, l) {
    this.id = a.toString()
    this.coordinate = b
    this.radius = c
    this.rippleNumber = h
  ...
  Polygon3DData = function(a, b, c, h, d, l, g, q) {
    this.id = a.toString()
    this.style = b
    this.coordinates = __convertCoordinatesForParts(c)
    this.color = __convertColor(h)
    this.height = d
    this.intensity = l
    this.tillingX = g
    this.tillingY = q
  },
  PolylineData = function(a, b, c, h, d, l, g, q, k, e) {
    this.id = a.toString()
    this.color = __convertColor(b)
    this.coordinates = c
    this.style = void 0 == h ? 0 : h
    this.thickness = void 0 == d ? 20 : d
    this.brightness = void 0 == l ? 0.5 : l
    this.flowRate = void 0 == g ? 0.5 : g
    this.tiling = q || 0
    this.depthTest = k || !0
    this.shape = void 0 == e ? 0 : e
  },
  ODLineData = function(a, b, c, h, d, l, g, q, k, e, f, p, t, r, x, u, z) {
    this.id = a.toString()
    this.color = __convertColor(b)
    this.coordinates = c
    this.flowRate = void 0 == h ? 0.5 : h
    ...
    this.labelSizeScale = void 0 == e ? 100 : e
    this.lineShape = void 0 == f ? 1 : f
    this.lineStyle = p || 0
    this.flowShape = t || 0
  ...
  PolygonData = function(a, b, c, h, d, l, g, q) {
    this.id = a.toString()
    this.color = __convertColor(b)
    this.coordinates = __convertCoordinatesForParts(c)
    this.framecolor = __convertColor(h)
    this.framethickness = d
    this.depthTest = l || !0
    this.brightness = g
    this.style = q
  },
  PanoramaData = function(a, b, c, h, d, l) {
    this.id = a.toString()
    this.imagePath = b
    this.coordinate = c
    this.yaw = h
  ...
  DecalData = function(a, b, c, h, d, l, g, q) {
    this.id = a.toString()
    this.order = b
    this.texturePath = c
    this.location = h
  ...
  TileLayerData = function(a, b, c, h, d) {
    this.id = a.toString()
    this.fileName = b
    this.location = c
    this.rotation = h
  ...
  CustomObjectData = function(a, b, c, h, d, l, g) {
    this.id = a
    this.pakFilePath = b
    this.assetPath = c
    this.location = h
  ...
  VideoProjectionData = function(a, b, c, h, d, l, g) {
    this.id = a
    this.videoURL = b
    this.location = c
    this.rotation = h
  ...
  BPFunctionData = function(a, b, c, h, d) {
    this.actorTag = a
    this.objectName = b
    this.functionName = c
    this.paramType = h
...
AirCityAPI.prototype.call0 = function(a, b) {
  this.call({ command: a }, b)
}
AirCityAPI.prototype.call = function(a, b) {
  this.webSocket && 1 != this.webSocket.readyState
    ? this.logWithColor("red", "Not connected!")
    : void 0 == a.command || a.command == CommandType.None
    ? this.logWithColor("red", "command is undefined or None")
    : ((a.timestamp = Date.now()),
      (a.callbackIndex = this._getCBIndex()),
      (a.__command = CommandType[a.command]),
      b && (this.callbackMap[a.command + "_" + a.callbackIndex] = b),
      (b = JSON.stringify(a)),
      this.log(""),
      this.logWithColor("RoyalBlue", "Request: " + CommandType[a.command], !0),
      this.logWithColor(
        "green",
...
AirCityAPI.prototype.callback = function(a) {
  if ((a = JSON.parse(a))) {
    var b = a.command + "_" + a.callbackIndex,
      c = this.callbackMap[b]
    if (c) {
      var h = CommandType[a.command]
      if ("Camera_Get" != h && "InfoTree_Get" != h && h.endsWith("_Get")) {
        if (a.data && a.data instanceof Array)
          if (1 == a.data.length) c(a.data[0])
          else if (1 < a.data.length) {
            h = {}
            for (
              var d = $jscomp.makeIterator(a.data), l = d.next();
              !l.done;
              l = d.next()
            )
              (l = l.value), (h[l.id] = l)
      ...
      delete this.callbackMap[b]
    }
    if (a.eventtype) this.onEvent(a)
  }
}
      ...
      (this.webSocket.onmessage = function(a) {
        ...
        try {
          var b = JSON.parse(a.data),
            c = b.versionNumber || b.versionnumber
          c &&
            ((this.misc.apiVersion = c),
            c != AcApiVersion &&
              alert(
                "JS SDK\u7248\u672c\u548c\u4e91\u6e32\u67d3\u670d\u52a1\u5668\u7248\u672c\u4e0d\u4e00\u81f4\uff1aS" +
                  c +
                  "C" +
                  AcApiVersion +
                  "\uff0c\n\u53ef\u80fd\u9020\u6210\u63a5\u53e3\u8c03\u7528\u9519\u8bef\uff0c\u8bf7\u786e\u8ba4!"
              ),
            this.misc.onApiVersionReceived &&
              this.misc.onApiVersionReceived.call(this.misc))
          if (b.command) {
            var h = Date.now() - b.timestamp
            this.logWithColor(
              "RoyalBlue",
              "Response: " + CommandType[b.command],
              !0
            )
            this.logWithColor(
              "green",
...
AirCityAPI.prototype.quit = function() {
  this.call0(CommandType.Quit)
}
AirCityAPI._ip2int = function(a) {
  a = a.split(".")
  return (
    (16777216 * Number(a[0]) +
      65536 * Number(a[1]) +
...
AirCityAPI.getHostFromInstanceId = function(a) {
  if (a && ((a = a.split("-")), 4 == a.length))
    return [AirCityAPI._int2ip(a[0]), a[3]]
}
AirCityAPI.Camera = function(a) {
  this.int = a
}
AirCityAPI.Camera.prototype.get = function(a) {
  this.int.call0(CommandType.Camera_Get, a)
}
AirCityAPI.Camera.prototype.set = function(a, b, c, h, d, l, g) {
  void 0 == h && (h = 0)
  void 0 == d && (d = 0)
...
AirCityAPI.Camera.prototype.lookAt = function(a, b, c, h, d, l, g, q) {
  "function" == typeof g && ((q = g), (g = void 0))
  this.int.call(
    {
      command: CommandType.Camera_Set,
      coordinate: [a, b, c],
...
AirCityAPI.Camera.prototype.lookAtBBox = function(a, b, c, h, d) {
  "function" == typeof h && ((d = h), (h = void 0))
  this.int.call(
    {
...
AirCityAPI.Camera.prototype.playAnimation = function(a, b) {
  this.int.call({ command: CommandType.Camera_PlayAnimation, id: a }, b)
}
AirCityAPI.Camera.prototype.stopAnimation = function(a) {
  this.int.call0(CommandType.Camera_StopAnimation, a)
}
...
AirCityAPI.Coord.prototype.world2Screen = function(a, b, c, h) {
  this.int.call(
...
AirCityAPI.InfoTree.prototype.get = function(a) {
  this.int.call0(CommandType.InfoTree_Get, a)
}
...
AirCityAPI.Object.prototype._processColorProps = function(a) {
  if (this.colorProps) {
    var b = this.colorProps.split("|")
    a = this.int.makeArray(a)
    a = $jscomp.makeIterator(a)
    for (var c = a.next(); !c.done; c = a.next()) {
      c = c.value
      for (var h = $jscomp.makeIterator(b), d = h.next(); !d.done; d = h.next())
        (d = d.value), c.hasOwnProperty(d) && (c[d] = __convertColor(c[d]))
    }
  }
}
AirCityAPI.Object.prototype.add = function(a, b) {
  this._processColorProps(a)
  this.int.call(
    { command: this._checkCommand("_Add"), data: this.int.makeArray(a) },
    b
  )
}
AirCityAPI.Object.prototype.update = function(a, b) {
  this._processColorProps(a)
  this.int.call(
...
AirCityAPI.Object.prototype.delete = function(a, b) {
  this.int.call(
    {
...
AirCityAPI.Object.prototype.clear = function(a) {
  this.int.call0(this._checkCommand("_Clear"), a)
}
AirCityAPI.Object.prototype.get = function(a, b) {
  this.int.call(
    { command: this._checkCommand("_Get"), ids: this.int.makeStringArray(a) },
    b
  )
}
AirCityAPI.Object.prototype.focus = function(a, b, c, h) {
...
AirCityAPI.Object.prototype.focusAll = function(a, b, c) {
...
AirCityAPI.Object.prototype.show = function(a, b) {
  this.int.call(
    { command: this._checkCommand("_Show"), ids: this.int.makeStringArray(a) },
    b
  )
}
AirCityAPI.Object.prototype.showAll = function(a) {
  this.int.call0(this._checkCommand("_ShowAll"), a)
}
AirCityAPI.Object.prototype.hide = function(a, b) {
  this.int.call(
    { command: this._checkCommand("_Hide"), ids: this.int.makeStringArray(a) },
    b
  )
}
AirCityAPI.Object.prototype.hideAll = function(a) {
  this.int.call0(this._checkCommand("_HideAll"), a)
}
AirCityAPI.Object.prototype._updateOneProp = function(a, b, c, h) {
  if (this._useBatchUpdate) {
    ...
    h ||
      ...
      (h.id = a.toString()),
      (h[b] = c),
      this._tempUpdateData.push(h))
  } else (d = {}), (d.id = a.toString()), (d[b] = c), this.update(d, h)
}
...
AirCityAPI.Object.prototype.updateEnd = function(a) {
  this.update(this._tempUpdateData, a)
  this._tempUpdateData = null
  this._useBatchUpdate = !1
}
var CameraTourKeyFrame = function(a, b, c, h) {
    this.index = a
    this.time = b
    this.location = c
    this.rotation = h
...
AirCityAPI.CameraTour.prototype.setUserData = function(a, b) {
  this._updateOneProp("userData", a, b)
}
AirCityAPI.CameraTour.prototype.setDuration = function(a, b) {
  this._updateOneProp("duration", a, b)
}
AirCityAPI.CameraTour.prototype.setKeyFrames = function(a, b) {
  this._updateOneProp("keyFrames", a, b)
}
AirCityAPI.CameraTour.prototype.setName = function(a, b) {
  this._updateOneProp("name", a, b)
}
...
AirCityAPI.TileLayer.prototype.enableClip = function(a, b) {
  ...
  for (var h = a.next(); !h.done; h = a.next())
    c.push({ id: h.value, allowClip: !0 })
  this.int.call({ command: CommandType.TileLayer_SetAllowClip, data: c }, b)
}
AirCityAPI.TileLayer.prototype.disableClip = function(a, b) {
  ...
  a = $jscomp.makeIterator(a)
  for (var h = a.next(); !h.done; h = a.next())
    c.push({ id: h.value, allowClip: !1 })
  this.int.call({ command: CommandType.TileLayer_SetAllowClip, data: c }, b)
}
AirCityAPI.TileLayer.prototype.setFileName = function(a, b, c) {
  AirCityAPI.Object.prototype._updateOneProp.call(this, a, "fileName", b, c)
}
AirCityAPI.TileLayer.prototype.setTranslation = function(a, b, c) {
  AirCityAPI.Object.prototype._updateOneProp.call(this, a, "location", b, c)
}
AirCityAPI.TileLayer.prototype.setRotation = function(a, b, c) {
  AirCityAPI.Object.prototype._updateOneProp.call(this, a, "rotation", b, c)
}
AirCityAPI.TileLayer.prototype.setScale = function(a, b, c) {
  AirCityAPI.Object.prototype._updateOneProp.call(this, a, "scale", b, c)
}
...
AirCityAPI.TileLayer.prototype.stopHighlightActor = function(a) {
  this.stopHighlightActors(a)
}
AirCityAPI.TileLayer.prototype.stopHighlightActors = function(a) {
  this.int.call0(CommandType.TileLayer_Actor_StopHightlight, a)
}
...
AirCityAPI.TileLayer.prototype.setStyle = function(a, b, c, h) {
  this.int.call(
    {
...
AirCityAPI.Tag.prototype.setCoordinate = function(a, b, c) {
  AirCityAPI.Object.prototype._updateOneProp.call(this, a, "coordinate", b, c)
}
AirCityAPI.Tag.prototype.setImagePath = function(a, b, c) {
  AirCityAPI.Object.prototype._updateOneProp.call(this, a, "imagePath", b, c)
}
AirCityAPI.Tag.prototype.setImageSize = function(a, b, c) {
  AirCityAPI.Object.prototype._updateOneProp.call(this, a, "imageSize", b, c)
}
AirCityAPI.Tag.prototype.setURL = function(a, b, c) {
  AirCityAPI.Object.prototype._updateOneProp.call(this, a, "url", b, c)
}
AirCityAPI.Tag.prototype.setText = function(a, b, c) {
  AirCityAPI.Object.prototype._updateOneProp.call(this, a, "text", b, c)
}
AirCityAPI.Tag.prototype.setRange = function(a, b, c) {
  AirCityAPI.Object.prototype._updateOneProp.call(this, a, "range", b, c)
}
AirCityAPI.Tag.prototype.setTextColor = function(a, b, c) {
  AirCityAPI.Object.prototype._updateOneProp.call(this, a, "textColor", b, c)
}
AirCityAPI.Tag.prototype.setTextBackgroundColor = function(a, b, c) {
  AirCityAPI.Object.prototype._updateOneProp.call(
    this,
    a,
    "textBackgroundColor",
    b,
...
AirCityAPI.Tag.prototype.setShowLine = function(a, b, c) {
  AirCityAPI.Object.prototype._updateOneProp.call(this, a, "showLine", b, c)
}
...
AirCityAPI.Tag.prototype.showAllPopupWindow = function(a) {
  this.int.call0(CommandType.Tag_PopupWindow_ShowAll, a)
}
AirCityAPI.Tag.prototype.hideAllPopupWindow = function(a) {
  this.int.call0(CommandType.Tag_PopupWindow_HideAll, a)
}
...
AirCityAPI.RadiationPoint = function(a) {
  AirCityAPI.Object.call(this, a, "RadiationPoint")
}
...
AirCityAPI.RadiationPoint.prototype.setRadius = function(a, b, c) {
  AirCityAPI.Object.prototype._updateOneProp.call(this, a, "radius", b, c)
}
AirCityAPI.RadiationPoint.prototype.setRippleNumber = function(a, b, c) {
  AirCityAPI.Object.prototype._updateOneProp.call(this, a, "rippleNumber", b, c)
}
...
AirCityAPI.RadiationPoint.prototype.setBrightness = function(a, b, c) {
  AirCityAPI.Object.prototype._updateOneProp.call(this, a, "brightness", b, c)
}
AirCityAPI.Polygon3D = function(a) {
  AirCityAPI.Object.call(this, a, "Polygon3D")
}
...
AirCityAPI.Polygon3D.prototype.setStyle = function(a, b, c) {
  AirCityAPI.Object.prototype._updateOneProp.call(this, a, "style", b, c)
}
AirCityAPI.Polygon3D.prototype.setCoordinates = function(a, b, c) {
  AirCityAPI.Object.prototype._updateOneProp.call(this, a, "coordinates", b, c)
}
...
AirCityAPI.Polygon3D.prototype.setHeight = function(a, b, c) {
  AirCityAPI.Object.prototype._updateOneProp.call(this, a, "height", b, c)
}
AirCityAPI.Polygon3D.prototype.setIntensity = function(a, b, c) {
  AirCityAPI.Object.prototype._updateOneProp.call(this, a, "intensity", b, c)
}
AirCityAPI.Polygon3D.prototype.setTillingX = function(a, b, c) {
  AirCityAPI.Object.prototype._updateOneProp.call(this, a, "tillingX", b, c)
}
AirCityAPI.Polygon3D.prototype.setTillingY = function(a, b, c) {
  AirCityAPI.Object.prototype._updateOneProp.call(this, a, "tillingY", b, c)
}
AirCityAPI.Polyline = function(a) {
  AirCityAPI.Object.call(this, a, "Polyline")
}
...
AirCityAPI.Polyline.prototype.setThickness = function(a, b, c) {
  AirCityAPI.Object.prototype._updateOneProp.call(this, a, "thickness", b, c)
}
...
AirCityAPI.Polyline.prototype.setFlowRate = function(a, b, c) {
  AirCityAPI.Object.prototype._updateOneProp.call(this, a, "flowRate", b, c)
}
AirCityAPI.Polyline.prototype.setBrightness = function(a, b, c) {
  AirCityAPI.Object.prototype._updateOneProp.call(this, a, "brightness", b, c)
}
AirCityAPI.Polyline.prototype.setShape = function(a, b, c) {
  AirCityAPI.Object.prototype._updateOneProp.call(this, a, "shape", b, c)
}
AirCityAPI.Polyline.prototype.setDepthTest = function(a, b, c) {
  AirCityAPI.Object.prototype._updateOneProp.call(this, a, "depthTest", b, c)
}
...
AirCityAPI.ODLine.prototype.setTiling = function(a, b, c) {
  AirCityAPI.Object.prototype._updateOneProp.call(this, a, "tiling", b, c)
}
AirCityAPI.ODLine.prototype.setBendDegree = function(a, b, c) {
  AirCityAPI.Object.prototype._updateOneProp.call(this, a, "bendDegree", b, c)
}
...
AirCityAPI.ODLine.prototype.setLineShape = function(a, b, c) {
  AirCityAPI.Object.prototype._updateOneProp.call(this, a, "lineShape", b, c)
}
AirCityAPI.ODLine.prototype.setLineStyle = function(a, b, c) {
  AirCityAPI.Object.prototype._updateOneProp.call(this, a, "lineStyle", b, c)
}
AirCityAPI.ODLine.prototype.setFlowShape = function(a, b, c) {
  AirCityAPI.Object.prototype._updateOneProp.call(this, a, "flowShape", b, c)
}
...
AirCityAPI.HeatMap.prototype.add = function(a, b, c, h, d) {
  ...
  this.int.call(
    {
      ...
      bbox: b,
      range: c,
      data: this.int.makeArray(h),
    },
    d
  )
}
AirCityAPI.HeatMap.prototype.update = function(a, b, c, h, d) {
...
AirCityAPI.HighlightArea = function(a) {
  AirCityAPI.Object.call(this, a, "HighlightArea")
}
...
AirCityAPI.HighlightArea.prototype.setHeightRange = function(a, b, c) {
  AirCityAPI.Object.prototype._updateOneProp.call(this, a, "heightRange", b, c)
}
...
AirCityAPI.VideoProjection.prototype.setVideoURL = function(a, b, c) {
  AirCityAPI.Object.prototype._updateOneProp.call(this, a, "videoURL", b, c)
}
...
AirCityAPI.VideoProjection.prototype.setFovy = function(a, b, c) {
  AirCityAPI.Object.prototype._updateOneProp.call(this, a, "fovy", b, c)
}
AirCityAPI.VideoProjection.prototype.setAspectRatio = function(a, b, c) {
  AirCityAPI.Object.prototype._updateOneProp.call(this, a, "aspectRatio", b, c)
}
AirCityAPI.VideoProjection.prototype.setDistance = function(a, b, c) {
  AirCityAPI.Object.prototype._updateOneProp.call(this, a, "distance", b, c)
}
...
var ViewshedData = function(a, b, c, h, d, l, g) {
  this.id = a.toString()
  this.coordinate = b
  this.fov = c
  this.radius = h
...
AirCityAPI.Misc.prototype.setDateTime = function(a, b, c, h, d, l, g, q) {
  this.int.call(
    {
      command: CommandType.Misc_SetDateTime,
      year: a,
      month: b,
      day: c,
      hour: h,
...
AirCityAPI.Misc.prototype.setMainUIVisibility = function(a, b) {
  this.int.call(
    { command: CommandType.Misc_SetMainUIVisibility, visible: a },
    b
  )
}
AirCityAPI.Misc.prototype.setQueryToolState = function(a, b) {
  this.int.call({ command: CommandType.Misc_SetQueryToolState, enabled: a }, b)
}
...
AirCityAPI.Misc.prototype.setApiVersionReceived = function(a) {
  this.onApiVersionReceived = a
}
AirCityAPI.Misc.prototype.playVideo = function(a, b, c, h, d, l, g) {
  this.int.call(
    {
      command: CommandType.Misc_PlayVideo,
      data: [{ id: a.toString(), position: [b, c], size: [h, d], url: l }],
    },
    g
  )
...
AirCityAPI.Misc.prototype.playMovie = function(a, b) {
  this.int.call({ command: CommandType.Misc_PlayMovie, url: a }, b)
}
AirCityAPI.Misc.prototype.stopMovie = function(a) {
  this.int.call({ command: CommandType.Misc_StopMovie }, a)
}
...
AirCityAPI.Misc.prototype.enterReportMode = function(a) {
  this.int.call0(CommandType.Misc_EnterReportMode)
}
AirCityAPI.Misc.prototype.exitReportMode = function(a) {
  this.int.call0(CommandType.Misc_ExitReportMode, a)
}
AirCityAPI.Misc.prototype.showAllFoliages = function(a) {
  this.int.call0(CommandType.Misc_ShowAllFoliages, a)
}
AirCityAPI.Misc.prototype.hideAllFoliages = function(a) {
  this.int.call0(CommandType.Misc_HideAllFoliages, a)
}
AirCityAPI.Misc.prototype.startPolygonClip = function(a, b) {
  this.int.tools.startPolygonClip(a, b)
}
AirCityAPI.Misc.prototype.stopClip = function(a) {
  this.int.tools.stopClip(a)
}
var MeasurementMode = {
  Coordinate: 1,
  Linear: 2,
...
AirCityAPI.Tools.prototype.startPolygonClip = function(a, b) {
  this.int.call(
    {
...
AirCityAPI.Tools.prototype.stopClip = function(a) {
  this.int.call0(CommandType.Tools_StopClip, a)
}
...
AirCityAPI.Tools.prototype.enterMeasurement = function(a) {
  this.int.call0(CommandType.Tools_EnterMeasurement, a)
}
AirCityAPI.Tools.prototype.exitMeasurement = function(a) {
  this.int.call0(CommandType.Tools_ExitMeasurement, a)
}
var MapMode = { Campass: 0, SmallMap: 1, BigMap: 2 }
...
AirCityAPI.Settings.prototype.getMapMode = function(a) {
  this.int.call0(CommandType.Settings_GetMapMode, a)
}
AirCityAPI.Settings.prototype.setMapURL = function(a, b) {
  this.int.call({ command: CommandType.Settings_SetMapURL, url: a }, b)
}
AirCityAPI.Settings.prototype.highlightColor = function(a, b) {
  this.setHighlightColor(a, b)
}
...
AirCityAPI.Settings.prototype.setFovX = function(a, b) {
  this.int.call({ command: CommandType.Settings_SetFovX, value: a }, b)
}
AirCityAPI.Settings.prototype.setOceanColor = function(a, b) {
  this.int.call({ command: CommandType.Settings_SetOceanColor, color: a }, b)
}
AirCityAPI.Weather = function(a) {
  this.int = a
}
AirCityAPI.Weather.prototype.getParams = function(a) {
  this.int.call0(CommandType.Weather_GetParams, a)
}
AirCityAPI.Weather.prototype._setParam = function(a, b) {
  this.int.call({ command: CommandType.Weather_SetParams, data: a }, b)
}
AirCityAPI.Weather.prototype.setDateTime = function(a, b, c, h, d, l, g) {
  this.int.call(
    {
...
AirCityAPI.Weather.prototype.setRainParam = function(a, b, c, h) {
  this.int.call(
    {
...
AirCityAPI.Weather.prototype.setSnowParam = function(a, b, c, h) {
  this.int.call(
    {
      command: CommandType.Weather_SetParams,
      rainsnow: 1,
...
AirCityAPI.Weather.prototype.setFogParam = function(a, b, c, h) {
  this.int.call(
    {
      command: CommandType.Weather_SetParams,
      fogDensity: a,
...
AirCityAPI.Weather.prototype.setCloudDensity = function(a, b) {
  this.int.call({ command: CommandType.Weather_SetParams, cloudDensity: a }, b)
}
AirCityAPI.Weather.prototype.setDarkMode = function(a, b) {
  this.int.call({ command: CommandType.Weather_SetParams, darkMode: !!a }, b)
}
AirCityAPI.EditHelper = function(a) {
  this.int = a
}
AirCityAPI.EditHelper.prototype.start = function(a) {
  this.int.call0(CommandType.CustomBuilder_Start, a)
}
AirCityAPI.EditHelper.prototype.cancel = function(a) {
  this.int.call0(CommandType.CustomBuilder_Quit, a)
}
AirCityAPI.EditHelper.prototype.finish = function(a, b) {
  this.int.call(
    { command: CommandType.CustomBuilder_Finish, withOffset: a || !0 },
    b
  )
}
AirCityAPI.EditHelper.prototype.setParam = function(a, b, c, h, d, l) {
  this.int.call(
    {
      command: CommandType.CustomBuilder_SetParam,
      lineType: a,
      buildType: b,
      drawType: c,
      color: __convertColor(h),
      drawThickness: d,
    },
    l
  )
  ...
  return (function() {
  ...
  })()(
    {
      ...
      2: [
        function(a, b, c) {
          function h(f) {
            ...
            if (null != f)
              for (var t in f)
                Object.prototype.hasOwnProperty.call(f, t) && (p[t] = f[t])
            p.default = f
            return p
          }
          Object.defineProperty(c, "__esModule", { value: !0 })
          c.adapterFactory = function() {
            var f = (0 < arguments.length && void 0 !== arguments[0]
                ? arguments[0]
                : {}
              ).window,
              p =
            ...
            switch (r.browser) {
              case "chrome":
                if (!l || !l.shimPeerConnection || !p.shimChrome) {
                ...
                x.browserShim = l
                l.shimGetUserMedia(f)
                l.shimMediaStream(f)
                l.shimPeerConnection(f)
                l.shimOnTrack(f)
                l.shimAddTrackRemoveTrack(f)
                l.shimGetSendersWithDtmf(f)
                l.shimGetStats(f)
                l.shimSenderReceiverGetStats(f)
                l.fixNegotiationNeeded(f)
                e.shimRTCIceCandidate(f)
                e.shimConnectionState(f)
                e.shimMaxMessageSize(f)
                e.shimSendThrowTypeError(f)
                e.removeAllowExtmapMixed(f)
                break
              case "firefox":
                if (!q || !q.shimPeerConnection || !p.shimFirefox) {
                  t("Firefox shim is not included in this adapter release.")
                  break
                }
                t("adapter.js shimming firefox.")
                x.browserShim = q
                q.shimGetUserMedia(f)
                q.shimPeerConnection(f)
                q.shimOnTrack(f)
                q.shimRemoveStream(f)
                q.shimSenderGetStats(f)
                q.shimReceiverGetStats(f)
                q.shimRTCDataChannel(f)
                q.shimAddTransceiver(f)
                q.shimGetParameters(f)
                q.shimCreateOffer(f)
                q.shimCreateAnswer(f)
                e.shimRTCIceCandidate(f)
                e.shimConnectionState(f)
                e.shimMaxMessageSize(f)
                e.shimSendThrowTypeError(f)
                break
              case "edge":
                if (!g || !g.shimPeerConnection || !p.shimEdge) {
                  t("MS edge shim is not included in this adapter release.")
                  break
                }
                t("adapter.js shimming edge.")
                x.browserShim = g
                g.shimGetUserMedia(f)
                g.shimGetDisplayMedia(f)
                g.shimPeerConnection(f)
                g.shimReplaceTrack(f)
                e.shimMaxMessageSize(f)
                e.shimSendThrowTypeError(f)
                break
              case "safari":
                ...
                x.browserShim = k
                k.shimRTCIceServerUrls(f)
                k.shimCreateOfferLegacy(f)
                k.shimCallbacksAPI(f)
                k.shimLocalStreamsAPI(f)
                k.shimRemoteStreamsAPI(f)
                k.shimTrackEventTransceiver(f)
                k.shimGetUserMedia(f)
                k.shimAudioContext(f)
                e.shimRTCIceCandidate(f)
                e.shimMaxMessageSize(f)
                e.shimSendThrowTypeError(f)
                e.removeAllowExtmapMixed(f)
      ...
      3: [
        function(a, b, c) {
          ...
          function d(e) {
            ...
            var f = e.RTCPeerConnection.prototype.addTrack
            e.RTCPeerConnection.prototype.addTrack = function(x, u) {
              if (!u) return f.apply(this, arguments)
              this._shimmedLocalStreams = this._shimmedLocalStreams || {}
            ...
            var p = e.RTCPeerConnection.prototype.addStream
            e.RTCPeerConnection.prototype.addStream = function(x) {
              var u = this
              this._shimmedLocalStreams = this._shimmedLocalStreams || {}
            ...
            e.RTCPeerConnection.prototype.removeStream = function(x) {
              this._shimmedLocalStreams = this._shimmedLocalStreams || {}
              delete this._shimmedLocalStreams[x.id]
              return t.apply(this, arguments)
            }
            var r = e.RTCPeerConnection.prototype.removeTrack
            e.RTCPeerConnection.prototype.removeTrack = function(x) {
              var u = this
              this._shimmedLocalStreams = this._shimmedLocalStreams || {}
              x &&
          ...
          c.shimMediaStream = function(e) {
            e.MediaStream = e.MediaStream || e.webkitMediaStream
          }
          c.shimOnTrack = function(e) {
            if (
              "object" !== ("undefined" === typeof e ? "undefined" : l(e)) ||
              !e.RTCPeerConnection ||
              "ontrack" in e.RTCPeerConnection.prototype
            )
              k.wrapPeerConnectionEvent(e, "track", function(p) {
                p.transceiver ||
                  Object.defineProperty(p, "transceiver", {
                    value: { receiver: p.receiver },
                  })
                return p
              })
            else {
              Object.defineProperty(e.RTCPeerConnection.prototype, "ontrack", {
                ...
                set: function(p) {
                  ...
                  this.addEventListener("track", (this._ontrack = p))
                },
                enumerable: !0,
                configurable: !0,
              })
              var f = e.RTCPeerConnection.prototype.setRemoteDescription
                ...
                this._ontrackpoly ||
                  ((this._ontrackpoly = function(t) {
                    t.stream.addEventListener("addtrack", function(r) {
                      var x = void 0
                      x = e.RTCPeerConnection.prototype.getReceivers
                        ? p.getReceivers().find(function(z) {
          ...
          c.shimGetSendersWithDtmf = function(e) {
            if (
              "object" === ("undefined" === typeof e ? "undefined" : l(e)) &&
              e.RTCPeerConnection &&
              ...
              if (!e.RTCPeerConnection.prototype.getSenders) {
                ...
                var p = e.RTCPeerConnection.prototype.addTrack
                e.RTCPeerConnection.prototype.addTrack = function(z, m) {
                  var n = p.apply(this, arguments)
                  n || ((n = f(this, z)), this._senders.push(n))
                  return n
                }
                var t = e.RTCPeerConnection.prototype.removeTrack
                e.RTCPeerConnection.prototype.removeTrack = function(z) {
              ...
              e.RTCPeerConnection.prototype.addStream = function(z) {
                var m = this
                this._senders = this._senders || []
                r.apply(this, [z])
                z.getTracks().forEach(function(n) {
                  m._senders.push(f(m, n))
                })
              }
              var x = e.RTCPeerConnection.prototype.removeStream
              e.RTCPeerConnection.prototype.removeStream = function(z) {
                var m = this
                this._senders = this._senders || []
                x.apply(this, [z])
                z.getTracks().forEach(function(n) {
              ...
              var u = e.RTCPeerConnection.prototype.getSenders
              e.RTCPeerConnection.prototype.getSenders = function() {
                var z = this,
                  m = u.apply(this, [])
          ...
          c.shimGetStats = function(e) {
            if (e.RTCPeerConnection) {
              var f = e.RTCPeerConnection.prototype.getStats
          ...
          c.shimSenderReceiverGetStats = function(e) {
            if (
              "object" === ("undefined" === typeof e ? "undefined" : l(e)) &&
              e.RTCPeerConnection &&
              e.RTCRtpSender &&
              ...
              if (!("getStats" in e.RTCRtpSender.prototype)) {
                var f = e.RTCPeerConnection.prototype.getSenders
                f &&
                  (e.RTCPeerConnection.prototype.getSenders = function() {
                    var x = this,
                      u = f.apply(this, [])
              ...
              if (!("getStats" in e.RTCRtpReceiver.prototype)) {
                ...
                k.wrapPeerConnectionEvent(e, "track", function(x) {
          ...
          c.shimAddTrackRemoveTrack = function(e) {
            function f(n, w) {
              var y = w.sdp
            ...
            if (e.RTCPeerConnection) {
              var t = k.detectBrowser(e)
              if (e.RTCPeerConnection.prototype.addTrack && 65 <= t.version)
                return d(e)
              ...
              var x = e.RTCPeerConnection.prototype.addStream
              e.RTCPeerConnection.prototype.addStream = function(n) {
                ...
                if (!this._reverseStreams[n.id]) {
                  var y = new e.MediaStream(n.getTracks())
              ...
              var u = e.RTCPeerConnection.prototype.removeStream
              ...
              e.RTCPeerConnection.prototype.addTrack = function(n, w) {
                var y = this
              ...
              ;["createOffer", "createAnswer"].forEach(function(n) {
                var w = e.RTCPeerConnection.prototype[n],
                  y = h({}, n, function() {
                    var A = this,
                      B = arguments
                ...
                e.RTCPeerConnection.prototype[n] = y[n]
              })
              var z = e.RTCPeerConnection.prototype.setLocalDescription
              e.RTCPeerConnection.prototype.setLocalDescription = function() {
                if (!arguments.length || !arguments[0].type)
                  return z.apply(this, arguments)
                arguments[0] = p(this, arguments[0])
                return z.apply(this, arguments)
              }
          ...
          c.shimPeerConnection = function(e) {
            var f = k.detectBrowser(e)
            !e.RTCPeerConnection &&
              e.webkitRTCPeerConnection &&
              (e.RTCPeerConnection = e.webkitRTCPeerConnection)
            if (e.RTCPeerConnection) {
              var p = 0 === e.RTCPeerConnection.prototype.addIceCandidate.length
              53 > f.version &&
                [
                  "setLocalDescription",
                  ...
                  var x = e.RTCPeerConnection.prototype[r],
                    u = h({}, r, function() {
                      arguments[0] = new ("addIceCandidate" === r
                        ? e.RTCIceCandidate
                        : e.RTCSessionDescription)(arguments[0])
                      return x.apply(this, arguments)
                    })
                  e.RTCPeerConnection.prototype[r] = u[r]
                })
          ...
          c.fixNegotiationNeeded = function(e) {
            var f = k.detectBrowser(e)
            k.wrapPeerConnectionEvent(e, "negotiationneeded", function(p) {
              var t = p.target
              if (
                !(
                  72 > f.version ||
          ...
          var k = (function(e) {
            ...
            if (null != e)
              for (var p in e)
                Object.prototype.hasOwnProperty.call(e, p) && (f[p] = e[p])
            f.default = e
            return f
          })(a("../utils.js"))
        },
      ...
      4: [
        function(a, b, c) {
          Object.defineProperty(c, "__esModule", { value: !0 })
          c.shimGetDisplayMedia = function(h, d) {
            ;(h.navigator.mediaDevices &&
              ...
              ("function" !== typeof d
                ...
                : (h.navigator.mediaDevices.getDisplayMedia = function(l) {
                    return d(l).then(function(g) {
                      var q = l.video && l.video.width,
                      ...
                      q && (l.video.mandatory.maxWidth = q)
                      k && (l.video.mandatory.maxHeight = k)
                      return h.navigator.mediaDevices.getUserMedia(l)
                    })
                  }))
          }
        },
      ...
      5: [
        function(a, b, c) {
            ...
            if (q.mediaDevices) {
              var k = d.detectBrowser(g),
                e = function(r) {
                  if (
                    "object" !==
                      ("undefined" === typeof r ? "undefined" : h(r)) ||
                    r.mandatory ||
                    r.optional
                  )
                    return r
                  ...
                  Object.keys(r).forEach(function(u) {
                    if (
                      ...
                      var z = "object" === h(r[u]) ? r[u] : { ideal: r[u] }
                      void 0 !== z.exact &&
                ...
                f = function(r, x) {
                  ...
                  if (r && "object" === h(r.video)) {
                    var z = r.video.facingMode
                    z =
                      z &&
                      ("object" ===
                      ("undefined" === typeof z ? "undefined" : h(z))
                        ? z
                        : { ideal: z })
                    u = 66 > k.version
                    if (
                      !(
                        ...
                        ("user" !== z.exact &&
                          ...
                          "user" !== z.ideal &&
                          "environment" !== z.ideal) ||
                        (q.mediaDevices.getSupportedConstraints &&
                          q.mediaDevices.getSupportedConstraints().facingMode &&
                          !u)
                      )
                    ) {
              ...
              q.getUserMedia = function(r, x, u) {
                f(r, function(z) {
                  q.webkitGetUserMedia(z, x, function(m) {
                    u && u(p(m))
                  })
                })
              }.bind(q)
              if (q.mediaDevices.getUserMedia) {
                var t = q.mediaDevices.getUserMedia.bind(q.mediaDevices)
                q.mediaDevices.getUserMedia = function(r) {
                  return f(r, function(x) {
                    return t(x).then(
                      function(u) {
                        if (
          ...
          var d = (function(g) {
              ...
              if (null != g)
                for (var k in g)
                  Object.prototype.hasOwnProperty.call(g, k) && (q[k] = g[k])
              q.default = g
              return q
            })(a("../utils.js")),
            l = d.log
        ...
        function(a, b, c) {
          ...
          c.shimRTCIceCandidate = function(g) {
            if (
              ...
              g.RTCIceCandidate = function(k) {
                "object" === ("undefined" === typeof k ? "undefined" : h(k)) &&
                  k.candidate &&
              ...
              var k = function(r) {
                ...
                p = function(r, x) {
                  ...
                  0 < r.length
                    ...
                    : "firefox" === q.browser && -1 !== x && (u = 2147483637)
                  return u
                },
          ...
          c.shimSendThrowTypeError = function(g) {
            function q(e, f) {
              ...
              e.send = function() {
                ...
                if (
                  "open" === e.readyState &&
                  f.sctp &&
                  t > f.sctp.maxMessageSize
                )
                  throw new TypeError(
                    "Message too large (can send a maximum of " +
                      f.sctp.maxMessageSize +
                      " bytes)"
                  )
            ...
            if (
              ...
              l.wrapPeerConnectionEvent(g, "datachannel", function(e) {
                q(e.channel, e.target)
                return e
              })
            }
          }
          ...
          c.removeAllowExtmapMixed = function(g) {
            if (g.RTCPeerConnection) {
              ...
              if (
                !(
                  ("chrome" === q.browser && 71 <= q.version) ||
                  ("safari" === q.browser && 605 <= q.version)
                )
              ) {
                ...
                g.RTCPeerConnection.prototype.setRemoteDescription = function(
                  ...
                  e &&
                    ...
                    (e.sdp = e.sdp
                      .split("\n")
                      .filter(function(f) {
                        return "a=extmap-allow-mixed" !== f.trim()
                      })
                      .join("\n"))
      ...
      7: [
        function(a, b, c) {
          ...
          c.shimPeerConnection = function(k) {
            ...
            k.RTCPeerConnection.prototype = p.prototype
          }
          ...
          c.filterIceServers = function(d, l) {
            ...
            return d.filter(function(q) {
              if (q && (q.urls || q.url)) {
                ...
                q.url &&
                  !q.urls &&
                  h.deprecated("RTCIceServer.url", "RTCIceServer.urls")
                var e = "string" === typeof k
                e && (k = [k])
                k = k.filter(function(f) {
                  return 0 === f.indexOf("stun:")
                    ? !1
                    : (f =
                        f.startsWith("turn") &&
                        !f.startsWith("turn:[") &&
                        f.includes("transport=udp")) && !g
                    ? (g = !0)
                    : f && !g
                })
                delete q.url
      ...
      9: [
        function(a, b, c) {
          Object.defineProperty(c, "__esModule", { value: !0 })
          c.shimGetDisplayMedia = function(h) {
            "getDisplayMedia" in h.navigator &&
              h.navigator.mediaDevices &&
              !(
                h.navigator.mediaDevices &&
                "getDisplayMedia" in h.navigator.mediaDevices
              ) &&
              (h.navigator.mediaDevices.getDisplayMedia = h.navigator.getDisplayMedia.bind(
                h.navigator
              ))
          }
        },
        ...
        function(a, b, c) {
          ...
          c.shimGetUserMedia = function(h) {
            ...
            var d = function(g) {
              ...
              l = h.mediaDevices.getUserMedia.bind(h.mediaDevices)
            h.mediaDevices.getUserMedia = function(g) {
              return l(g).catch(function(q) {
        ...
        function(a, b, c) {
                ...
                [
                  ...
                  var x = k.RTCPeerConnection.prototype[r],
                    u = h({}, r, function() {
                      arguments[0] = new ("addIceCandidate" === r
                        ? k.RTCIceCandidate
                        : k.RTCSessionDescription)(arguments[0])
                      return x.apply(this, arguments)
                    })
                  k.RTCPeerConnection.prototype[r] = u[r]
                })
              if (68 > e.version) {
                var f = k.RTCPeerConnection.prototype.addIceCandidate
                    ...
                    if (53 > e.version && !x)
                      try {
                        ...
                        z.forEach(function(n, w) {
                          z.set(
                            w,
                            Object.assign({}, n, { type: p[n.type] || n.type })
                          )
                        })
                      }
                    return z
          ...
          c.shimSenderGetStats = function(k) {
            if (
              ...
              var e = k.RTCPeerConnection.prototype.getSenders
              e &&
              ...
              var f = k.RTCPeerConnection.prototype.addTrack
              f &&
          ...
          c.shimReceiverGetStats = function(k) {
            if (
              ...
              var e = k.RTCPeerConnection.prototype.getReceivers
              e &&
              ...
              q.wrapPeerConnectionEvent(k, "track", function(f) {
                f.receiver._pc = f.srcElement
                return f
              })
          ...
          c.shimRemoveStream = function(k) {
            !k.RTCPeerConnection ||
              ...
              (k.RTCPeerConnection.prototype.removeStream = function(e) {
                var f = this
                q.deprecated("removeStream", "removeTrack")
                this.getSenders().forEach(function(p) {
                  p.track && e.getTracks().includes(p.track) && f.removeTrack(p)
                })
              })
          }
          ...
          c.shimAddTransceiver = function(k) {
            if (
              ...
              var e = k.RTCPeerConnection.prototype.addTransceiver
              e &&
                (k.RTCPeerConnection.prototype.addTransceiver = function() {
                  this.setParametersPromises = []
                  var f = arguments[1],
                    p = f && "sendEncodings" in f
                  p &&
                    f.sendEncodings.forEach(function(x) {
                  ...
                  if (p) {
                    ...
                    p = r.getParameters()
                    "encodings" in p ||
                      ((p.encodings = f.sendEncodings),
                      (r.sendEncodings = f.sendEncodings),
          ...
          c.shimCreateOffer = function(k) {
            if (
              ...
              var e = k.RTCPeerConnection.prototype.createOffer
          ...
          c.shimCreateAnswer = function(k) {
            if (
              ...
              var e = k.RTCPeerConnection.prototype.createAnswer
      ...
      13: [
        function(a, b, c) {
          ...
          c.shimGetUserMedia = function(l) {
            ...
            q.getUserMedia = function(t, r, x) {
              d.deprecated(
                "navigator.getUserMedia",
                "navigator.mediaDevices.getUserMedia"
              )
              q.mediaDevices.getUserMedia(t).then(r, x)
            }
            if (
              !(
                55 < g.version &&
                "autoGainControl" in q.mediaDevices.getSupportedConstraints()
              )
            ) {
              var k = function(t, r, x) {
                  r in t && !(x in t) && ((t[x] = t[r]), delete t[r])
                },
                e = q.mediaDevices.getUserMedia.bind(q.mediaDevices)
              q.mediaDevices.getUserMedia = function(t) {
              ...
              if (l && l.prototype.applyConstraints) {
                var p = l.prototype.applyConstraints
        ...
        function(a, b, c) {
            ...
            if (
              ...
              if (!("addStream" in g.RTCPeerConnection.prototype)) {
                ...
                g.RTCPeerConnection.prototype.addStream = function(k) {
                  ...
                  k.getAudioTracks().forEach(function(f) {
                    return q.call(e, f, k)
                  })
                  k.getVideoTracks().forEach(function(f) {
                    return q.call(e, f, k)
                  })
                }
                g.RTCPeerConnection.prototype.addTrack = function(k) {
                  ...
                  p &&
                    p.forEach(function(r) {
                      e._localStreams
                        ? e._localStreams.includes(r) || e._localStreams.push(r)
                        : (e._localStreams = [r])
                    })
              ...
              "removeStream" in g.RTCPeerConnection.prototype ||
                (g.RTCPeerConnection.prototype.removeStream = function(k) {
                  var e = this
                  this._localStreams || (this._localStreams = [])
                  var f = this._localStreams.indexOf(k)
                  if (-1 !== f) {
                    this._localStreams.splice(f, 1)
                    var p = k.getTracks()
                    this.getSenders().forEach(function(t) {
                      p.includes(t.track) && e.removeTrack(t)
                    })
                  }
                })
            }
                    ...
                    this.addEventListener(
                      ...
                      (this._onaddstreampoly = function(f) {
                        f.streams.forEach(function(p) {
                          ...
                          if (!e._remoteStreams.includes(p)) {
                            e._remoteStreams.push(p)
                ...
                this._onaddstreampoly ||
                  this.addEventListener(
                    ...
                    (this._onaddstreampoly = function(e) {
                      e.streams.forEach(function(f) {
                        k._remoteStreams || (k._remoteStreams = [])
                        if (!(0 <= k._remoteStreams.indexOf(f))) {
                          k._remoteStreams.push(f)
          ...
          c.shimGetUserMedia = function(g) {
            ...
            if (q.mediaDevices && q.mediaDevices.getUserMedia) {
              ...
              q.mediaDevices.getUserMedia = function(e) {
                return k(h(e))
              }
            }
            !q.getUserMedia &&
              q.mediaDevices &&
              q.mediaDevices.getUserMedia &&
              (q.getUserMedia = function(e, f, p) {
                q.mediaDevices.getUserMedia(e).then(f, p)
              }.bind(q))
          }
          c.shimConstraints = h
          c.shimRTCIceServerUrls = function(g) {
            var q = g.RTCPeerConnection
            g.RTCPeerConnection = function(k, e) {
              if (k && k.iceServers) {
                for (var f = [], p = 0; p < k.iceServers.length; p++) {
                  var t = k.iceServers[p]
                  !t.hasOwnProperty("urls") && t.hasOwnProperty("url")
                    ? (l.deprecated("RTCIceServer.url", "RTCIceServer.urls"),
                      ...
                      delete t.url,
                      f.push(t))
                    : f.push(k.iceServers[p])
                }
                k.iceServers = f
              }
              return new q(k, e)
            }
            g.RTCPeerConnection.prototype = q.prototype
          ...
          c.shimCreateOfferLegacy = function(g) {
            ...
            g.RTCPeerConnection.prototype.createOffer = function(k) {
              if (k) {
                ...
                var e = this.getTransceivers().find(function(f) {
                  return "audio" === f.receiver.track.kind
                })
                !1 === k.offerToReceiveAudio && e
                ...
                e = this.getTransceivers().find(function(f) {
                  return "video" === f.receiver.track.kind
                })
                !1 === k.offerToReceiveVideo && e
                  ? "sendrecv" === e.direction
                    ? e.setDirection
                      ? e.setDirection("sendonly")
                      : (e.direction = "sendonly")
      ...
      15: [
        function(a, b, c) {
          ...
          function d(f, p, t) {
            return (f = f.match(p)) && f.length >= t && parseInt(f[t], 10)
          }
          function l(f) {
            return "[object Object]" !== Object.prototype.toString.call(f)
              ? f
              : Object.keys(f).reduce(function(p, t) {
                  var r =
                      "[object Object]" ===
                      Object.prototype.toString.call(f[t]),
                    x = r ? l(f[t]) : f[t]
                  r = r && !Object.keys(x).length
                  return void 0 === x || r ? p : Object.assign(p, h({}, t, x))
                }, {})
          }
          function g(f, p, t) {
            p &&
          ...
          c.extractVersion = d
          c.wrapPeerConnectionEvent = function(f, p, t) {
            if (f.RTCPeerConnection) {
              f = f.RTCPeerConnection.prototype
              var r = f.addEventListener
              f.addEventListener = function(u, z) {
                if (u !== p) return r.apply(this, arguments)
                var m = function(n) {
                  ;(n = t(n)) && (z.handleEvent ? z.handleEvent(n) : z(n))
                }
                this._eventMap = this._eventMap || {}
                this._eventMap[p] || (this._eventMap[p] = new Map())
                this._eventMap[p].set(z, m)
                return r.apply(this, [u, m])
              }
              var x = f.removeEventListener
              f.removeEventListener = function(u, z) {
                if (
                  u !== p ||
                  !this._eventMap ||
                  !this._eventMap[p] ||
                  !this._eventMap[p].has(z)
                )
                  return x.apply(this, arguments)
                var m = this._eventMap[p].get(z)
                this._eventMap[p].delete(z)
                0 === this._eventMap[p].size && delete this._eventMap[p]
              ...
              Object.defineProperty(f, "on" + p, {
                ...
                set: function(u) {
                  this["_on" + p] &&
                    (this.removeEventListener(p, this["_on" + p]),
                    delete this["_on" + p])
                  u && this.addEventListener(p, (this["_on" + p] = u))
                },
                enumerable: !0,
                configurable: !0,
              })
          ...
          c.disableLog = function(f) {
            return "boolean" !== typeof f
              ? Error(
                  "Argument type: " +
                    ("undefined" === typeof f ? "undefined" : q(f)) +
          ...
          c.disableWarnings = function(f) {
            ...
            e = !f
            return (
              "adapter.js deprecation warnings " + (f ? "disabled" : "enabled")
            )
          }
          c.log = function() {
            "object" !==
          ...
          c.deprecated = function(f, p) {
            e &&
              console.warn(f + " is deprecated, please use " + p + " instead.")
          }
          c.detectBrowser = function(f) {
            var p = f.navigator,
              t = { browser: null, version: null }
            if ("undefined" === typeof f || !f.navigator)
              return (t.browser = "Not a browser."), t
            p.mozGetUserMedia
              ? ((t.browser = "firefox"),
                (t.version = d(p.userAgent, /Firefox\/(\d+)\./, 1)))
              : p.webkitGetUserMedia ||
                (!1 === f.isSecureContext &&
                  f.webkitRTCPeerConnection &&
                  !f.RTCIceGatherer)
              ? ((t.browser = "chrome"),
                (t.version = d(p.userAgent, /Chrom(e|ium)\/(\d+)\./, 2)))
              : p.mediaDevices && p.userAgent.match(/Edge\/(\d+).(\d+)$/)
              ? ((t.browser = "edge"),
                (t.version = d(p.userAgent, /Edge\/(\d+).(\d+)$/, 2)))
              : f.RTCPeerConnection && p.userAgent.match(/AppleWebKit\/(\d+)\./)
              ? ((t.browser = "safari"),
                (t.version = d(p.userAgent, /AppleWebKit\/(\d+)\./, 1)),
                (t.supportsUnifiedPlan =
                  f.RTCRtpTransceiver &&
                  "currentDirection" in f.RTCRtpTransceiver.prototype))
              : (t.browser = "Not a supported browser.")
            return t
          }
          c.compactObject = l
          c.walkStats = g
          c.filterStats = function(f, p, t) {
            var r = t ? "outbound-rtp" : "inbound-rtp",
              x = new Map()
            if (null === p) return x
            var u = []
            f.forEach(function(z) {
              "track" === z.type && z.trackIdentifier === p.id && u.push(z)
            })
            u.forEach(function(z) {
              f.forEach(function(m) {
                m.type === r && m.trackId === z.id && g(f, m, x)
              })
            })
            return x
          }
      ...
      16: [
        function(a, b, c) {
          function h(f, p, t, r, x) {
            p = e.writeRtpDescription(f.kind, p)
            p += e.writeIceParameters(f.iceGatherer.getLocalParameters())
            p += e.writeDtlsParameters(
              f.dtlsTransport.getLocalParameters(),
              "offer" === t ? "actpass" : x || "active"
            )
            p += "a=mid:" + f.mid + "\r\n"
            p =
              f.rtpSender && f.rtpReceiver
                ? p + "a=sendrecv\r\n"
                : f.rtpSender
                ? p + "a=sendonly\r\n"
                : f.rtpReceiver
                ...
                : p + "a=inactive\r\n"
            f.rtpSender &&
              ((t = f.rtpSender._initialTrackId || f.rtpSender.track.id),
              (f.rtpSender._initialTrackId = t),
              (r = "msid:" + (r ? r.id : "-") + " " + t + "\r\n"),
              (p =
                p +
                ("a=" + r) +
                ("a=ssrc:" + f.sendEncodingParameters[0].ssrc + " " + r)),
              f.sendEncodingParameters[0].rtx &&
                ((p +=
                  "a=ssrc:" + f.sendEncodingParameters[0].rtx.ssrc + " " + r),
                (p +=
                  "a=ssrc-group:FID " +
                  f.sendEncodingParameters[0].ssrc +
                  " " +
                  f.sendEncodingParameters[0].rtx.ssrc +
                  "\r\n")))
            p +=
              "a=ssrc:" +
              f.sendEncodingParameters[0].ssrc +
          ...
          function l(f, p) {
            ...
            f.codecs.forEach(function(u) {
              for (var z = 0; z < p.codecs.length; z++) {
                var m = p.codecs[z]
                if (
            ...
            f.headerExtensions.forEach(function(u) {
              for (var z = 0; z < p.headerExtensions.length; z++) {
                var m = p.headerExtensions[z]
                if (u.uri === m.uri) {
          ...
          function q(f, p) {
            var t = f.getRemoteCandidates().find(function(r) {
              return (
                p.foundation === r.foundation &&
                p.ip === r.ip &&
                p.port === r.port &&
          ...
          var e = a("sdp")
          b.exports = function(f, p) {
            function t(m, n) {
              n.addTrack(m)
              n.dispatchEvent(
                new f.MediaStreamTrackEvent("addtrack", { track: m })
              )
            }
            function r(m, n) {
              n.removeTrack(m)
              n.dispatchEvent(
                new f.MediaStreamTrackEvent("removetrack", { track: m })
              )
            }
            function x(m, n, w, y) {
            ...
            u.prototype.addTrack = function(m, n) {
              ...
              w.track = m
              w.stream = n
              w.rtpSender = new f.RTCRtpSender(m, w.dtlsTransport)
              return w.rtpSender
            }
            ...
            u.prototype.removeTrack = function(m) {
              ...
              if (!(m instanceof f.RTCRtpSender))
                throw new TypeError(
                  "Argument 1 of RTCPeerConnection.removeTrack does not implement interface RTCRtpSender."
                )
              ...
              if (!y.onlocalcandidate) {
                ...
                y.onlocalcandidate = function(B) {
                  if (!(w.usingBundle && 0 < n)) {
                    ...
                    F = e.getMediaSections(w._localDescription.sdp)
                    ...
                    w._localDescription.sdp =
                      e.getDescription(w._localDescription.sdp) + F.join("")
            ...
            u.prototype.setLocalDescription = function(m) {
              ...
              if ("offer" === m.type) {
                var w = e.splitSections(m.sdp)
                var y = w.shift()
                w.forEach(function(B, C) {
                  B = e.parseRtpParameters(B)
                ...
                w = e.splitSections(n._remoteDescription.sdp)
                y = w.shift()
                var A = 0 < e.matchPrefix(y, "a=ice-lite").length
                w.forEach(function(B, C) {
                  ...
                  if (
                    !(
                      (e.isRejected(B) &&
                        0 === e.matchPrefix(B, "a=bundle-only").length) ||
                      F.rejected
                    )
                  ) {
                    var M = e.getIceParameters(B, y)
                    B = e.getDtlsParameters(B, y)
                    A && (B.role = "server")
                    ;(n.usingBundle && 0 !== C) ||
                      (n._gather(F.mid, C),
                      "new" === E.state &&
            ...
            u.prototype.setRemoteDescription = function(m) {
              ...
              var y = [],
                A = e.splitSections(m.sdp),
                B = A.shift(),
                C = 0 < e.matchPrefix(B, "a=ice-lite").length,
                F = 0 < e.matchPrefix(B, "a=group:BUNDLE ").length
              n.usingBundle = F
              var L = e.matchPrefix(B, "a=ice-options:")[0]
              ...
              A.forEach(function(E, D) {
                var H = e.splitLines(E),
                  I = e.getKind(E),
                  M =
                    e.isRejected(E) &&
                    0 === e.matchPrefix(E, "a=bundle-only").length,
                  P = H[0].substr(2).split(" ")[2]
                H = e.getDirection(E, B)
                var J = e.parseMsid(E),
                  R = e.getMid(E) || e.generateIdentifier()
                if (
                  M ||
                  ("application" === I &&
                  ...
                  var T = e.parseRtpParameters(E)
                  if (!M) {
                    var S = e.getIceParameters(E, B)
                    var U = e.getDtlsParameters(E, B)
                    U.role = "client"
                  }
                  P = e.parseRtpEncodingParameters(E)
                  var V = e.parseRtcpParameters(E),
                    W = 0 < e.matchPrefix(E, "a=end-of-candidates", B).length,
                    Q = e
                      .matchPrefix(E, "a=candidate:")
                      .map(function(K) {
                        return e.parseCandidate(K)
                      })
                      .filter(function(K) {
                  ...
                  if ("offer" !== m.type || M)
                    "answer" !== m.type ||
                      ...
                      !N || ("sendrecv" !== H && "sendonly" !== H)
                        ...
                        : ((H = N.track),
                          J
                            ? (w[J.stream] ||
                                (w[J.stream] = new f.MediaStream()),
                              t(H, w[J.stream]),
                              y.push([H, N, w[J.stream]]))
                            : (w.default || (w.default = new f.MediaStream()),
                              t(H, w.default),
                    ...
                    E = f.RTCRtpReceiver.getCapabilities(I)
                    15019 > p &&
                    ...
                    if ("sendrecv" === H || "sendonly" === H) {
                      ...
                      var N =
                        G.rtpReceiver ||
                        new f.RTCRtpReceiver(G.dtlsTransport, I)
                      if (S) {
                        H = N.track
                        if (!J || "-" !== J.stream)
                          if (J) {
            ...
            u.prototype.createOffer = function(m) {
              ...
              for (
                n.transceivers.forEach(function(B) {
                  "audio" === B.kind
                    ...
                    : "video" === B.kind && (y--, 0 > y && (B.wantReceive = !1))
                });
                0 < w || 0 < y;
              ...
              var A = e.writeSessionBoilerplate(
                n._sdpSessionId,
              ...
              n.transceivers.forEach(function(B, C) {
                var F = B.track,
                  L = B.kind,
                  E = B.mid || e.generateIdentifier()
                B.mid = E
                B.iceGatherer ||
                  (B.iceGatherer = n._createIceGatherer(C, n.usingBundle))
                E = f.RTCRtpSender.getCapabilities(L)
                15019 > p &&
                ...
                B.wantReceive &&
                  (B.rtpReceiver = new f.RTCRtpReceiver(B.dtlsTransport, L))
              ...
              n.transceivers.forEach(function(B, C) {
                A += h(B, B.localCapabilities, "offer", B.stream, n._dtlsRole)
                A += "a=rtcp-rsize\r\n"
                !B.iceGatherer ||
                  ...
                  (B.iceGatherer.getLocalCandidates().forEach(function(F) {
                    F.component = 1
                    A += "a=" + e.writeCandidate(F) + "\r\n"
                  }),
                  "completed" === B.iceGatherer.state &&
                    (A += "a=end-of-candidates\r\n"))
              })
              m = new f.RTCSessionDescription({ type: "offer", sdp: A })
            ...
            u.prototype.createAnswer = function() {
              ...
              var w = e.getMediaSections(m._remoteDescription.sdp).length
              m.transceivers.forEach(function(A, B) {
                if (!(B + 1 > w))
                  if (A.rejected)
                    ...
                    n += h(A, B, "answer", A.stream, m._dtlsRole)
                    A.rtcpParameters &&
                      A.rtcpParameters.reducedSize &&
                      (n += "a=rtcp-rsize\r\n")
                  }
              })
              var y = new f.RTCSessionDescription({ type: "answer", sdp: n })
                    ...
                    if (n._remoteDescription)
                      if (m && "" !== m.candidate) {
                        ...
                        if (F) {
                          ...
                          w = e.getMediaSections(n._remoteDescription.sdp)
                          w[B] +=
            ...
            u.prototype.getStats = function(m) {
              if (m && m instanceof f.MediaStreamTrack) {
                var n = null
            ...
            ;[
              ...
              if ((m = f[m]) && m.prototype && m.prototype.getStats) {
      ...
      17: [
        function(a, b, c) {
          ...
          h.splitSections = function(d) {
            return d.split("\nm=").map(function(l, g) {
              return (0 < g ? "m=" + l : l).trim() + "\r\n"
            })
          }
          h.getDescription = function(d) {
            return (d = h.splitSections(d)) && d[0]
          }
          h.getMediaSections = function(d) {
            d = h.splitSections(d)
            d.shift()
            return d
          }
          h.matchPrefix = function(d, l) {
            return h.splitLines(d).filter(function(g) {
              return 0 === g.indexOf(l)
            })
          }
          h.parseCandidate = function(d) {
            d =
          ...
          h.parseIceOptions = function(d) {
            return d.substr(14).split(" ")
          }
          h.parseRtpMap = function(d) {
            d = d.substr(9).split(" ")
          ...
          h.parseFmtp = function(d) {
            for (
              var l = {}, g = d.substr(d.indexOf(" ") + 1).split(";"), q = 0;
              q < g.length;
              q++
            )
              (d = g[q].trim().split("=")), (l[d[0].trim()] = d[1])
            return l
          }
          h.writeFmtp = function(d) {
            var l = "",
              g = d.payloadType
          ...
          h.parseRtcpFb = function(d) {
            d = d.substr(d.indexOf(" ") + 1).split(" ")
            return { type: d.shift(), parameter: d.join(" ") }
          }
          h.writeRtcpFb = function(d) {
            var l = "",
              g = d.payloadType
            void 0 !== d.preferredPayloadType && (g = d.preferredPayloadType)
            d.rtcpFeedback &&
              d.rtcpFeedback.length &&
              d.rtcpFeedback.forEach(function(q) {
                l +=
                  "a=rtcp-fb:" +
                  g +
                  " " +
                  q.type +
                  (q.parameter && q.parameter.length ? " " + q.parameter : "") +
                  "\r\n"
              })
            return l
          }
          h.parseSsrcMedia = function(d) {
            var l = d.indexOf(" "),
              g = { ssrc: parseInt(d.substr(7, l - 7), 10) },
              q = d.indexOf(":", l)
            ;-1 < q
              ? ((g.attribute = d.substr(l + 1, q - l - 1)),
                (g.value = d.substr(q + 1)))
              : (g.attribute = d.substr(l + 1))
            return g
          }
          h.parseSsrcGroup = function(d) {
            d = d.substr(13).split(" ")
            return {
              semantics: d.shift(),
          ...
          h.getMid = function(d) {
            if ((d = h.matchPrefix(d, "a=mid:")[0])) return d.substr(6)
          }
          h.parseFingerprint = function(d) {
            d = d.substr(14).split(" ")
            return { algorithm: d[0].toLowerCase(), value: d[1] }
          }
          h.getDtlsParameters = function(d, l) {
            return {
              role: "auto",
              fingerprints: h
                .matchPrefix(d + l, "a=fingerprint:")
                .map(h.parseFingerprint),
            }
          }
          h.writeDtlsParameters = function(d, l) {
            var g = "a=setup:" + l + "\r\n"
            d.fingerprints.forEach(function(q) {
              g += "a=fingerprint:" + q.algorithm + " " + q.value + "\r\n"
            })
            return g
          }
          h.parseCryptoLine = function(d) {
            d = d.substr(9).split(" ")
            return {
              tag: parseInt(d[0], 10),
              cryptoSuite: d[1],
          ...
          h.writeCryptoLine = function(d) {
            return (
              ...
              ("object" === typeof d.keyParams
                ? h.writeCryptoKeyParams(d.keyParams)
                : d.keyParams) +
              (d.sessionParams ? " " + d.sessionParams.join(" ") : "") +
              "\r\n"
            )
          }
          h.parseCryptoKeyParams = function(d) {
          ...
          h.writeCryptoKeyParams = function(d) {
            return (
              d.keyMethod +
              ":" +
              d.keySalt +
          ...
          h.getCryptoParameters = function(d, l) {
            return h.matchPrefix(d + l, "a=crypto:").map(h.parseCryptoLine)
          }
          h.getIceParameters = function(d, l) {
            var g = h.matchPrefix(d + l, "a=ice-ufrag:")[0]
            d = h.matchPrefix(d + l, "a=ice-pwd:")[0]
            return g && d
              ? { usernameFragment: g.substr(12), password: d.substr(10) }
              : null
          }
          h.writeIceParameters = function(d) {
            return (
              "a=ice-ufrag:" +
              d.usernameFragment +
              "\r\na=ice-pwd:" +
          ...
          h.parseRtpParameters = function(d) {
            for (
              var l = {
                  codecs: [],
                  headerExtensions: [],
                ...
                g = h.splitLines(d)[0].split(" "),
                q = 3;
              q < g.length;
              q++
            ) {
              var k = g[q],
                e = h.matchPrefix(d, "a=rtpmap:" + k + " ")[0]
              if (e) {
                e = h.parseRtpMap(e)
                var f = h.matchPrefix(d, "a=fmtp:" + k + " ")
                e.parameters = f.length ? h.parseFmtp(f[0]) : {}
                e.rtcpFeedback = h
                ...
                switch (e.name.toUpperCase()) {
                  case "RED":
                  case "ULPFEC":
                    l.fecMechanisms.push(e.name.toUpperCase())
                }
              }
            }
            h.matchPrefix(d, "a=extmap:").forEach(function(p) {
              l.headerExtensions.push(h.parseExtmap(p))
            })
            return l
          }
          h.writeRtpDescription = function(d, l) {
            var g = ""
            g += "m=" + d + " "
          ...
          h.parseRtpEncodingParameters = function(d) {
            var l = [],
              g = h.parseRtpParameters(d),
              q = -1 !== g.fecMechanisms.indexOf("RED"),
              k = -1 !== g.fecMechanisms.indexOf("ULPFEC"),
              e = h
                .matchPrefix(d, "a=ssrc:")
                .map(function(r) {
                  return h.parseSsrcMedia(r)
                })
                .filter(function(r) {
                  return "cname" === r.attribute
                }),
              f = 0 < e.length && e[0].ssrc,
              p
            e = h.matchPrefix(d, "a=ssrc-group:FID").map(function(r) {
              return r
                .substr(17)
                .split(" ")
                .map(function(x) {
            ...
            0 < e.length && 1 < e[0].length && e[0][0] === f && (p = e[0][1])
            g.codecs.forEach(function(r) {
              "RTX" === r.name.toUpperCase() &&
                ...
                q &&
                  ((r = JSON.parse(JSON.stringify(r))),
                  (r.fec = { ssrc: f, mechanism: k ? "red+ulpfec" : "red" }),
                  l.push(r)))
            })
            0 === l.length && f && l.push({ ssrc: f })
            var t = h.matchPrefix(d, "b=")
            t.length &&
              ((t =
          ...
          h.parseRtcpParameters = function(d) {
            var l = {},
              g = h
                .matchPrefix(d, "a=ssrc:")
                .map(function(q) {
                  return h.parseSsrcMedia(q)
                })
                .filter(function(q) {
                  return "cname" === q.attribute
                })[0]
            g && ((l.cname = g.value), (l.ssrc = g.ssrc))
            g = h.matchPrefix(d, "a=rtcp-rsize")
            l.reducedSize = 0 < g.length
            l.compound = 0 === g.length
            d = h.matchPrefix(d, "a=rtcp-mux")
            l.mux = 0 < d.length
            return l
          }
          h.parseMsid = function(d) {
            var l = h.matchPrefix(d, "a=msid:")
            if (1 === l.length)
              return (
          ...
          h.parseSctpDescription = function(d) {
            var l = h.parseMLine(d),
              g = h.matchPrefix(d, "a=max-message-size:"),
              q
            0 < g.length && (q = parseInt(g[0].substr(19), 10))
            isNaN(q) && (q = 65536)
            g = h.matchPrefix(d, "a=sctp-port:")
            if (0 < g.length)
              return {
            ...
            if (0 < h.matchPrefix(d, "a=sctpmap:").length)
              return (
                (d = h
                  .matchPrefix(d, "a=sctpmap:")[0]
                  .substr(10)
                  .split(" ")),
                { port: parseInt(d[0], 10), protocol: d[1], maxMessageSize: q }
              )
          }
          h.writeSctpDescription = function(d, l) {
            d =
          ...
          h.writeSessionBoilerplate = function(d, l, g) {
            l = void 0 !== l ? l : 2
            d = d ? d : h.generateSessionId()
            return (
              "v=0\r\no=" +
              (g || "thisisadapterortc") +
              " " +
          ...
          h.writeMediaSection = function(d, l, g, q) {
            l = h.writeRtpDescription(d.kind, l)
            l += h.writeIceParameters(d.iceGatherer.getLocalParameters())
            l += h.writeDtlsParameters(
          ...
          h.getDirection = function(d, l) {
            ...
            return l ? h.getDirection(l) : "sendrecv"
          }
          h.getKind = function(d) {
            return h
              .splitLines(d)[0]
              .split(" ")[0]
              .substr(2)
          }
          h.isRejected = function(d) {
            return "0" === d.split(" ", 2)[1]
          }
          h.parseMLine = function(d) {
            d = h
              .splitLines(d)[0]
              .substr(2)
              .split(" ")
...
var WS_OPEN_STATE = 1,
  ...
  AirCityPlayer = function(a, b, c, h, d) {
    ;(this.container = document.getElementById(b))
      ? ((this.uniqueId = Date.now()),
        0 != d &&
          ((this.startupInfoPanelVisible = d), this.createStartupInfoPanel()),
        (b = a.split("-")),
        4 == b.length && (a = AirCityPlayer._int2ip(b[0]) + ":" + b[2]),
        this.logStartupInfo("Host: " + a),
        (this.url = "ws://" + a),
        (this.token = c || ""),
        (this.infoMarkerVisible = h),
...
AirCityPlayer.prototype.onResize = function(a) {
  this.container &&
    ((this.parentClientRect = this.container.getBoundingClientRect()),
    this.video &&
      (this.autoAdjustResolution && this.updateVideoStreamSize(),
      this.setupNormalizeAndQuantize()),
    (a = this.container.getBoundingClientRect()),
    this.playerInfoPanelMarker &&
      ((this.playerInfoPanelMarker.style.left = a.left + 10 + "px"),
      (this.playerInfoPanelMarker.style.top = a.bottom - 30 + "px")),
    this.playerInfoPanel &&
      ((this.playerInfoPanel.style.left = a.left + 10 + "px"),
      (this.playerInfoPanel.style.top = a.bottom - 250 + "px")),
    this.startupInfoPanel &&
      ((this.startupInfoPanel.style.left = a.left + "px"),
      (this.startupInfoPanel.style.top = a.top + "px"),
      (this.startupInfoPanel.style.height = a.height - 20 + "px")))
}
...
AirCityPlayer.prototype.setResolution = function(a, b) {
  ...
  this.emitDescriptor(MessageType.UIInteraction, a)
  console.log(a)
}
AirCityPlayer.prototype.updateVideoStreamSize = function() {
  3840 < this.container.clientWidth ||
    2160 < this.container.clientHeight ||
...
AirCityPlayer.prototype.setupNormalizeAndQuantize = function() {
  ...
  if (a > b) {
    ...
    var h = b / a
    this.normalizeAndQuantizeUnsigned = function(d, l) {
      d = h * (d / this.container.clientWidth - 0.5) + 0.5
    ...
    this.unquantizeAndDenormalizeUnsigned = function(d, l) {
      return {
        x: ((d / 65536 - 0.5) / h + 0.5) * this.container.clientWidth,
        y: (l / 65536) * this.container.clientHeight,
      }
    }.bind(this)
    this.normalizeAndQuantizeSigned = function(d, l) {
      return {
        x: ((h * d) / (0.5 * this.container.clientWidth)) * 32767,
...
AirCityPlayer.prototype.emitDescriptor = function(a, b) {
  ...
  c.setUint8(h, a)
  h++
  c.setUint16(h, b.length, !0)
  h += 2
  for (a = 0; a < b.length; a++) c.setUint16(h, b.charCodeAt(a), !0), (h += 2)
  this.sendInputData(c.buffer)
}
AirCityPlayer.prototype.emitMouseMove = function(a, b, c, h) {
  a = this.normalizeAndQuantizeUnsigned(a, b)
  c = this.normalizeAndQuantizeSigned(c, h)
  h = new DataView(new ArrayBuffer(9))
  h.setUint8(0, MessageType.MouseMove)
  h.setUint16(1, a.x, !0)
  h.setUint16(3, a.y, !0)
  h.setInt16(5, c.x, !0)
  h.setInt16(7, c.y, !0)
  this.sendInputData(h.buffer)
}
...
AirCityPlayer.prototype.releaseMouseButtons = function(a, b, c) {
  a & MouseButtonsMask.PrimaryButton &&
    this.emitMouseUp(MouseButton.MainButton, b, c)
  a & MouseButtonsMask.SecondaryButton &&
    this.emitMouseUp(MouseButton.SecondaryButton, b, c)
  a & MouseButtonsMask.AuxiliaryButton &&
    this.emitMouseUp(MouseButton.AuxiliaryButton, b, c)
  a & MouseButtonsMask.FourthButton &&
    this.emitMouseUp(MouseButton.FourthButton, b, c)
  a & MouseButtonsMask.FifthButton &&
    this.emitMouseUp(MouseButton.FifthButton, b, c)
}
AirCityPlayer.prototype.pressMouseButtons = function(a, b, c) {
  a & MouseButtonsMask.PrimaryButton &&
    this.emitMouseDown(MouseButton.MainButton, b, c)
  a & MouseButtonsMask.SecondaryButton &&
    this.emitMouseDown(MouseButton.SecondaryButton, b, c)
  a & MouseButtonsMask.AuxiliaryButton &&
    this.emitMouseDown(MouseButton.AuxiliaryButton, b, c)
  a & MouseButtonsMask.FourthButton &&
    this.emitMouseDown(MouseButton.FourthButton, b, c)
  a & MouseButtonsMask.FifthButton &&
    this.emitMouseDown(MouseButton.FifthButton, b, c)
}
...
AirCityPlayer.prototype.registerTouchEvents = function() {
  ...
  this.rememberTouch = function(b) {
    ...
    fingerIds[b.identifier] = c
  }
  this.forgetTouch = function(b) {
    fingers.push(fingerIds[b.identifier])
    delete fingerIds[b.identifier]
  }
  this.emitTouchData = function(b, c) {
    var h = new DataView(new ArrayBuffer(2 + 6 * c.length))
    h.setUint8(0, b)
    h.setUint8(1, c.length)
    b = 2
    for (var d = 0; d < c.length; d++) {
      ...
      h.setUint16(b, g.y, !0)
      b += 2
      h.setUint8(b, fingerIds[l.identifier], !0)
      b += 1
      h.setUint8(b, 255 * l.force, !0)
      b += 1
    }
    this.sendInputData(h.buffer)
  }.bind(this)
  if (this.fakeMouseWithTouches) {
    ...
    this.container.ontouchstart = function(b) {
      if (void 0 === a) {
        ...
        a = {
          id: c.identifier,
          x: c.clientX - this.parentClientRect.left,
          y: c.clientY - this.parentClientRect.top,
        }
    ...
    this.container.ontouchend = function(b) {
      for (var c = 0; c < b.changedTouches.length; c++) {
        var h = b.changedTouches[c]
        if (h.identifier === a.id) {
          this.emitMouseUp(
            MouseButton.MainButton,
            h.clientX - this.parentClientRect.left,
            h.clientY - this.parentClientRect.top
          )
    ...
    this.container.ontouchmove = function(b) {
      for (var c = 0; c < b.touches.length; c++) {
        var h = b.touches[c]
        if (h.identifier === a.id) {
          c = h.clientX - this.parentClientRect.left
          h = h.clientY - this.parentClientRect.top
          this.emitMouseMove(c, h, c - a.x, h - a.y)
          a.x = c
          a.y = h
          break
        }
    ...
    (this.container.ontouchstart = function(b) {
      for (var c = 0; c < b.changedTouches.length; c++)
        rememberTouch(b.changedTouches[c])
      ...
      (this.container.ontouchend = function(b) {
        ...
        for (var c = 0; c < b.changedTouches.length; c++)
          forgetTouch(b.changedTouches[c])
        b.preventDefault()
      }.bind(this)),
      (this.container.ontouchmove = function(b) {
...
AirCityPlayer.prototype.showStartupInfoPanel = function() {
  this.startupInfoPanel &&
    ((this.startupInfoPanel.innerText = ""),
    (this.startupInfoPanel.style.display = "block"))
}
...
AirCityPlayer.prototype.generateAggregatedStats = function(a) {
  ...
  a.forEach(
    function(f) {
      "inbound-rtp" != f.type ||
        f.isRemote ||
        ("video" != f.mediaType && !f.id.toLowerCase().includes("video")) ||
        ((b.timestamp = f.timestamp),
        (b.bytesReceived = f.bytesReceived),
        (b.framesDecoded = f.framesDecoded),
        (b.packetsLost = f.packetsLost),
      ...
      "track" == f.type &&
        f.frameWidth &&
        ((b.framesDropped = f.framesDropped),
        (b.framesReceived = f.framesReceived),
        (b.framesDroppedPercentage =
          (f.framesDropped / f.framesReceived) * 100),
        (b.frameHeight = f.frameHeight),
        (b.frameWidth = f.frameWidth),
        (b.frameHeightStart =
        ...
        (b.frameWidthStart =
          this.stats && this.stats.frameWidthStart
            ...
            : f.frameWidth))
      "candidate-pair" == f.type &&
        f.hasOwnProperty("currentRoundTripTime") &&
        0 != f.currentRoundTripTime &&
        (b.currentRoundTripTime = f.currentRoundTripTime)
    }.bind(this)
  )
  this.stats = b
  1e5 <
  ...
  if (this.isInfoPanelVisible) {
    ...
    for (
      var c = new Intl.NumberFormat(window.navigator.language, {
        ...
        h = (this.stats.timestamp - this.stats.timestampStart) / 1e3,
        d = [],
        l = [60, 60],
        g = 0;
      g < l.length;
    ...
    g = "B"
    for (
      var q = this.stats.hasOwnProperty("bytesReceived")
          ? this.stats.bytesReceived
          : 0,
        k = ["kB", "MB", "GB"],
        e = 0;
    ...
    document.getElementById("playerInfoDuration_" + this.uniqueId).innerText =
      c.format(d) + ":" + c.format(l) + ":" + c.format(h)
...
AirCityPlayer.prototype.initWebRTC = function(a) {
  a = a || {}
  ...
  this.sdpConstraints = { offerToReceiveAudio: 1, offerToReceiveVideo: 1 }
  ...
  this.video.addEventListener(
    "loadedmetadata",
    function(b) {
      if (this.ws && this.ws.readyState === WS_OPEN_STATE) this.onResize()
    }.bind(this),
    !0
  )
...
AirCityPlayer.prototype.setupWebRTCConnection = function() {
  ...
  this.pcClient.onicecandidate = function(b) {
    ...
    if (b.candidate && b.candidate.candidate)
      this.onWebRtcCandidate(b.candidate)
  }.bind(this)
  try {
    ...
    a.onmessage = function(b) {
      ...
      if (this.onDataChannelMessage) this.onDataChannelMessage(b.data)
    }.bind(this)
    this.dcClient = a
  } catch (b) {
    console.warn("No data channel", b),
      this.logStartupInfo("No data channel!"),
      (this.dcClient = null)
  }
...
AirCityPlayer.prototype.onConfig = function(a) {
  ...
  this.logStartupInfo("Create Player")
  this.initWebRTC({ peerConnectionOptions: a.peerConnectionOptions })
  this.onWebRtcOffer = function(b) {
    this.ws &&
  ...
  this.onWebRtcCandidate = function(b) {
    this.ws &&
      this.ws.readyState === WS_OPEN_STATE &&
      (console.log("-> SS: iceCandidate\n" + JSON.stringify(b, void 0, 4)),
      this.ws.send(JSON.stringify({ type: "iceCandidate", candidate: b })))
  }.bind(this)
  this.onDataChannelConnected = function() {
    this.ws &&
      this.ws.readyState === WS_OPEN_STATE &&
      this.logStartupInfo("Connected, waiting for video...")
  }.bind(this)
  this.onDataChannelMessage = function(b) {}.bind(this)
  this.logStartupInfo("Connecting...")
  this.setupWebRTCConnection()
  this.onResize()
  this.logStartupInfo("Register UI Events")
...
AirCityPlayer.prototype.connect = function() {
  ...
  window.WebSocket
    ? (this.logStartupInfo("Connecting SignallingServer..."),
      ...
      (this.ws.onmessage = function(a) {
        ...
        switch (a.type) {
          ...
          case "answer":
            ...
            break
          case "iceCandidate":
            console.log("ICE candidate: ", a.candidate)
            ...
            break
          default:
            console.log("invalid message type: " + a.type)
        }
      }.bind(this)),
      ...
      (this.ws.onclose = function(a) {
        ...
        console.log(b)
        this.ws = void 0
        4e3 == a.code || 4001 == a.code
          ? this.destroy()
          : this.video &&
            (this.container.removeChild(this.video), this.closeWebRTC())
        this.isInvalidToken ||
          this.isDestroyed ||
          setTimeout(
            function() {
...
AirCityPlayer.prototype.start = function() {
  this.delayStartTimerId = setTimeout(
    function() {
      ...
      window.addEventListener("resize", this.onResize.bind(this), !0)
...
AirCityPlayer.getHostFromInstanceId = function(a) {
  if (a && ((a = a.split("-")), 4 == a.length))
    return [AirCityPlayer._int2ip(a[0]), a[2]]
}
